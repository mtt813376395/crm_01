									...
									<TD height=25>
										<TABLE cellSpacing=0 cellPadding=2 border=0>
											<tr>
											  <td>联系人名称：</td>
								              <td>
								                   <s:textfield name="lkmName" class="textbox" id="sChannel2" style="WIDTH: 100px" maxLength="50"></s:textfield>
								              </td>
								              <td>联系人职位 ：</td>
								              <td>
								                   <s:textfield name="lkmPosition" class="textbox" id="sChannel2" style="WIDTH: 100px" maxLength="50"></s:textfield>
								              </td>
								              <td>所属客户：</td>
								              <td colspan="3">
									               <s:select name="customer.custId" list="customers" listKey="custId" listValue="custName" headerKey="" headerValue="--请选择--" class="textbox" id="sChannel2" style="WIDTH: 100px" maxLength="50"></s:select>
								              </td>    
								              <td>联系人性别：</td>
								              <td>
								                  <s:select list="#{'1':'男','0':'女'}" name="lkmGender" headerKey="" headerValue="---请选择---" class="textbox" id="sChannel2" style="WIDTH: 100px" maxLength="50"></s:select>
